  ...
  return (
    <>
      <NextSeo
        ...
        description="Personal portfolio, blog, and digital products by Your Name. Discover my projects, read my thoughts, and explore my digital creations."
        openGraph={{
          type: "website",
          locale: "en_US",
          url: "https://alvaro-blog.netlify.app/",
          siteName: "Alvaro Martin Caballero",
        }}
      />
      <Head>
